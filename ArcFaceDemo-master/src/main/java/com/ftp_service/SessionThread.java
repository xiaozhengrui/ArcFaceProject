...
/**
 * Created by techwinxiao on 18-2-8.
 */
...
public class SessionThread extends Thread {
    ...
    private File workingDir = Environment.getExternalStorageDirectory();//FsSettings.getChrootDir();
    ...
    public boolean isAuthenticated() {
        return userAuthenticated || /*FsSettings.allowAnoymous()*/true;
    }
